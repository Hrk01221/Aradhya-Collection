...
const Sidebar = () => {
  ...
  return (
    <div
      className={`fixed top-22 left-0 w-[80%] h-[calc(100vh-5.5rem)] bg-bg shadow-2xl
    ...
    >
      ...
      <div className="w-full flex flex-col gap-2 mb-15 ">
        <div className="w-full flex px-4 py-2 gap-4 items-center border border-slate-500 rounded-xl">
